...
![vm rodando em um terminal]({{ site.baseurl }}/assets/images/t1_vm.png)
...
![evidência de filesystem compartilhado]({{ site.baseurl }}/assets/images/t1_shared_fs.png)
